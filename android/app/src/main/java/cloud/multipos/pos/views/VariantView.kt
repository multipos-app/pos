...
class VariantView (val listener: InputListener, list: ArrayList <Jar>, title: String): SelectView (listener, list, title) {
	 
	 override fun line (context: Context, jar: Jar, position: Int): LinearLayout {

		  return VariantLine (context, jar, position)
	 }
	 
	 inner class VariantLine (context: Context, line: Jar, position: Int): LinearLayout (context) {
