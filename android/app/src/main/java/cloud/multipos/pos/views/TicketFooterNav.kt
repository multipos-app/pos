...
class TicketFooterNav (context: Context, attrs: AttributeSet): LinearLayout (context, attrs), PosDisplay, ThemeListener {
	 ...
	 init {
		  ...
		  wash = findViewById (R.id.ticket_nav_wash) as PosIconText
		  textViews.add (wash)
		  wash?.setOnClickListener {

				Control.factory ("LaundryJobs").action (Jar ())
		  }
