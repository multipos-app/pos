...
class PullTabPayoutView (val listener: InputListener, list: ArrayList <Jar>, title: String): SelectView (listener, list, title) {
	 
	 override fun line (context: Context, jar: Jar, position: Int): LinearLayout {

		  return PullTabPayoutLine (context, jar, position)
	 }
	 
	 inner class PullTabPayoutLine (context: Context, line: Jar, position: Int): LinearLayout (context) {
