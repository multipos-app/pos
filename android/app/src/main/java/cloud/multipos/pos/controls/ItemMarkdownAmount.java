...
public class ItemMarkdownAmount extends ItemMarkdown implements InputListener {

	 public ItemMarkdownAmount () { super (); }
	 ...
	 public void accept (Jar result) {
		  ...
		  if (jar ().has ("receipt_desc")) {
				...
				jar ().put ("receipt_desc", Pos.app.getString ("discount") + " " + Strings.currency (amount, true));
		  }
